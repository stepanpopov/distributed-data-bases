...
-- Номера для отеля 2 (Neva Palace) - ID: 2, 5, 8, 11, 14, 17, 20
...
-- Удобства для отеля 2 - ID: 2, 5, 8, 11
...
-- Сотрудники отеля 2 - ID: 2, 5, 8, 11
...
-- Бронирования для отеля 2 - ID: 2, 5, 8
